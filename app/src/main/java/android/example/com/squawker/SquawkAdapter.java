...
public class SquawkAdapter extends RecyclerView.Adapter<SquawkAdapter.SquawkViewHolder> {
    ...
    @Override public SquawkViewHolder onCreateViewHolder(  ViewGroup parent,  int viewType) {
        return new SquawkViewHolder( (View) LayoutInflater  .from( parent.getContext())  .inflate( R.layout.item_squawk_list, parent, false));
    }

    @Override public void onBindViewHolder( SquawkViewHolder holder, int position) {
        ...
        // Change how the date is displayed depending on whether it was written in the last minute, the hour, etc.
        ...
        // Choose the correct, and in this case, locally stored asset for the instructor.
        //  If there were more users, you'd probably download this as part of the message.
        switch (authorKey) {
            case SquawkContract.ASSER_KEY:      holder.authorImageView.setImageResource( R.drawable.asser);      break;
            case SquawkContract.CEZANNE_KEY:    holder.authorImageView.setImageResource( R.drawable.cezanne);    break;
            case SquawkContract.JLIN_KEY:       holder.authorImageView.setImageResource( R.drawable.jlin);       break;
            case SquawkContract.LYLA_KEY:       holder.authorImageView.setImageResource( R.drawable.lyla);       break;
            case SquawkContract.NIKITA_KEY:     holder.authorImageView.setImageResource( R.drawable.nikita);     break;
            default:                            holder.authorImageView.setImageResource( R.drawable.test);
        }
    }

    @Override public int getItemCount() { return  (null != mData)  ?  mData.getCount()  :  0; }
